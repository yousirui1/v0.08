...
public class ChatUIPage : UIPage
{
    ...
    public override void Awake(GameObject go)
    {
		...
		tablistMain.Add(new TabIndex(0, "好友", PathObj.chat_panel));	
		tablistMain.Add(new TabIndex(1, "粉丝", PathObj.chat_panel));	
		tablistMain.Add(new TabIndex(2, "添加", PathObj.chat_panel));	
